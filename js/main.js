...
function pre_loader() {
	...
	if(check == true) {
		...
		document.getElementById('titletransparent').style.position="absolute";
		document.getElementById('title').style.top="0px"
		document.getElementById('titletransparent').style.top="130px"
		document.getElementById('navbar').style.top="155px"
		document.getElementById('main').style.top="225px"
		document.getElementById('main').style.width="100%";
		document.getElementById('main').style.left="0px";
		document.getElementById('main').style.fontSize="250%";
		...
		document.getElementById('titletransparent').style.height="25px";
		...
		document.getElementById('navbar').style.fontSize="50px";
		document.getElementById('title').style.height="145px";
		...
		if(window.innerWidth <= "499") {
			...
			document.getElementById('titletransparent').style.position="absolute";
			document.getElementById('title').style.top="0px"
			document.getElementById('titletransparent').style.top="50px"
			...
			document.getElementById('titletransparent').style.position="absolute";
			document.getElementById('title').style.top="0px"
			document.getElementById('titletransparent').style.top="70px"
